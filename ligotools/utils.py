...
def plotting(fs, template_p, template_c, time, template_offset, strain_H1,
             strain_L1, tevent, eventname, bb, ab, normalization, make_plots,
             plottype, dt, strain_L1_whitenbp, strain_H1_whitenbp):
    ...
    for det in dets:
        ...
        print('For detector {0}, maximum at {1:.4f} with SNR = {2:.1f}, D_eff = {3:.2f}, horizon = {4:0.1f} Mpc'.format(det, timemax, SNRmax, d_eff, horizon))
